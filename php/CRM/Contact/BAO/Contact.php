...
WHERE     civicrm_contact.id = " . CRM_Utils_Type::escape($id, 'Integer');
  ...
  // add employer address
    $currentEmployer_address['employer_street_address'] = array ('name' => 'employer_street_address',
                                             'where' => 'civicrm_address.street_address',
                                             'title' => ts('Employer Street Address'));

    $currentEmployer_address['employer_supplemental_address1']  = array ('name' => 'employer_supplemental_address1',
                                             'where' => 'civicrm_address.supplemental_address_1',
                                             'title' => ts('Employer Supplemental Address 1'));

    $currentEmployer_address['employer_supplemental_address2']  = array ('name' => 'employer_supplemental_address2',
                                             'where' => 'civicrm_address.supplemental_address_2',
                                             'title' => ts('Employer Supplemental Address 2'));


    $currentEmployer_address['employer_city'] = array ('name' => 'employer_city',
                                             'where' => 'civicrm_address.city',
                                             'title' => ts('Employer City'));


    $currentEmployer_address['employer_postal_code']  = array ('name' => 'employer_postal_code',
                                             'where' => 'civicrm_address.postal_code',
                                             'title' => ts('Employer Postal Code'));
    
    $currentEmployer_address['employer_postal_code_suffix'] = array ('name' => 'employer_postal_code_suffix',
                                             'where' => 'civicrm_address.postal_code_suffix',
                                             'title' => ts('Employer Postal Code Suffix'));


    $currentEmployer_address['employer_county'] = array ('name' => 'employer_county',
                                             'where' => 'civicrm_state_province.name',
                                             'title' => ts('Employer County'));
    ...
    $currentEmployer_address['employer_country']  = array ('name' => 'employer_country',
                                             'where' => 'civicrm_country.name',
                                             'title' => ts('Employer Country'));
    


    /*$currentEmployer_address['employer_address']  = array ('name' => 'employer_address',
                                             'where' => 'civicrm_address.street_address',
                                             'title' => ts('Employer Address'));*/

    $fields = array_merge($fields, $currentEmployer_address);
