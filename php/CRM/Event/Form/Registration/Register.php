    ...
    {  
        ...
        if ( $this->_values['event']['is_multiple_registrations'] ) {
            ...
            if ( !$this->_allowConfirmation || $this->_additionalParticipantIds ) {
                ...
                $additionalOptions = array( '' => ts('1'),1 => ts('2'),2 => ts('3'),3 => ts('4'),4 => ts('5' ),5  => ts('6'),6 => ts('7'),7 => ts('8'),8 => ts('9'),9 => ts('10'),10 => ts('11'),11 => ts('12'),12 => ts('13'),13 => ts('14'),14 => ts('15'),15 => ts('16'),16 => ts('17'),17 => ts('18'),18 => ts('19'),19 => ts('20') );
