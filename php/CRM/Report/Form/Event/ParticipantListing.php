...
class CRM_Report_Form_Event_ParticipantListing extends CRM_Report_Form {
    ...
    function __construct( ) {
        $this->_columns = 
            array( 
                  ...
                  'civicrm_value_group_21' =>
                  array( 'dao'     => 'CRM_Event_DAO_Participant',
                         'fields'  =>
                         array( 'group_registration_90' => 
                                array( 'title'     => ts( 'Group Name' ),
                                       'no_repeat' => true ),
                                ),
                         'grouping'  => 'contact-fields',
                         'filters' =>             
                  ...
                  'civicrm_value_membership_no_26' =>
                  array( 'dao'     => 'CRM_Contact_DAO_Contact',
                         'fields'  =>
                         array( 'membership_no_100' => 
                                array( 'title'     => ts( 'Membership No.' ),
                                       'no_repeat' => true ),
                                ),
                         'grouping'  => 'contact-fields',
                         'filters' =>             
    ...
    function from( ) {
        ...
        FROM civicrm_participant {$this->_aliases['civicrm_participant']}
            ...
            LEFT JOIN civicrm_value_group_21 {$this->_aliases['civicrm_value_group_21']} 
                    ON ({$this->_aliases['civicrm_value_group_21']}.entity_id  = {$this->_aliases['civicrm_participant']}.id  )
            LEFT JOIN civicrm_value_membership_no_26 {$this->_aliases['civicrm_value_membership_no_26']} 
                    ON ({$this->_aliases['civicrm_value_membership_no_26']}.entity_id  = {$this->_aliases['civicrm_contact']}.id  )
    ...
    function groupBy( ) {
        ...
        if ( CRM_Utils_Array::value( 'group_bys', $this->_params ) &&
            ...
            $this->_groupBy = "ORDER BY  membership_no_100,group_registration_90 Asc";
        }
    }
