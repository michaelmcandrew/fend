...
{if $form.additional_participants.html}
    <div class="crm-section additional_participants-section" id="noOfparticipants">
        ...
        <div class="content">
            ...
            <span class="description">{ts}Enter the first participant's details on this page.  You will be able to enter details of any other participants on following pages.{/ts}</span>
        </div>
        <div class="clear"></div>
    </div>
{/if}
